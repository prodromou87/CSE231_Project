...
define i32 @_Z3fooj(i32) #0 {
  ...
  %5 = icmp ugt i32 %4, 5
  call void @updateMap(i32 2, i32 1)
  call void @updateMap(i32 29, i32 2)
  call void @updateMap(i32 30, i32 1)
  call void @updateMap(i32 31, i32 2)
  call void @updateMap(i32 51, i32 1)
...
; <label>:6:                                      ; preds = %1
  ...
  call void @updateMap(i32 2, i32 1)
  call void @updateMap(i32 11, i32 1)
  call void @updateMap(i32 30, i32 1)
  call void @updateMap(i32 31, i32 1)
  br label %12
...
; <label>:12:                                     ; preds = %9, %6
  ...
  %15 = add i32 %13, %14
  call void @updateMap(i32 1, i32 1)
  call void @updateMap(i32 11, i32 1)
  call void @updateMap(i32 30, i32 2)
  call void @printOutInstrInfo()
  ret i32 %15
}

declare void @updateMap(i32, i32)
