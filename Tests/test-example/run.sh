...
$LLVM_BIN/opt -load $LIB_DIR/CSE231.so -cse231-csi < /tmp/test1.ll > /dev/null 2> /tmp/csi.result
$LLVM_BIN/opt -load $LIB_DIR/CSE231.so -cse231-cdi < /tmp/test1.ll -o /tmp/test1-cdi.bc
$LLVM_BIN/opt -load $LIB_DIR/CSE231.so -cse231-bb < /tmp/test1.ll -o /tmp/test1-bb.bc
